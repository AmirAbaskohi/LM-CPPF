...
import pandas as pd
from src.few_shot_paraphrasing import gpt, opt
from src.back_translation import bt
...
class FewShotDataset(torch.utils.data.Dataset):
    ...
    def new_convert_fn(
        ...
        if not use_demo:
            ...
            # intermediary_language = 'de'
            # back_translation_example = [bt(example, ) for example in augmented_example]
            #
            # bt_inputs = tokenize_multipart_input(
            #     input_text_list=back_translation_example,
            #     max_length=max_length,
            #     tokenizer=self.tokenizer,
            #     task_name=self.args.task_name,
            #     prompt=prompt,
            ...
            ######## For Few-shot Paraphrasing GPT-3
            # gpt_examples = [gpt(example, args.task_name) for example in augmented_example]
            #
            # gpt_inputs = tokenize_multipart_input(
            #     input_text_list=gpt_examples,
            #     max_length=max_length,
            #     tokenizer=self.tokenizer,
            #     task_name=self.args.task_name,
            #     prompt=prompt,
            ...
            ######## For Few-shot Paraphrasing OPT-175B
            # opt_examples = [opt(example, args.task_name) for example in augmented_example]
            #
            # opt_inputs = tokenize_multipart_input(
            #     input_text_list=opt_examples,
            #     max_length=max_length,
            #     tokenizer=self.tokenizer,
            #     task_name=self.args.task_name,
            #     prompt=prompt,
